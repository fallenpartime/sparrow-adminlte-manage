            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label>简介</label>
                            <textarea class="form-control" name="description" rows="3" placeholder="请输入简介" required>{{ $record->description }}</textarea>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>内容</label>
                            <textarea id="content" name="content" rows="3" placeholder="请输入内容" required>{{ $record->content }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
